...
- Detect number plates in images and videos in real-time.
- Extract number plate regions for OCR processing.
- Recognize alphanumeric characters from Indian license plates.
- Logs recognized plates in **CSV** or **MySQL database**.
- Pre-processing for better OCR accuracy (handling black text, noise, etc.).
